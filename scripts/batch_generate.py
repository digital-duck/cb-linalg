...
Usage examples:
    ...
    python scripts/batch_generate.py --include eigenvectors,determinant

    # Skip specific targets
    python scripts/batch_generate.py --exclude gram_schmidt
...
# concept is actually mathematical. "college" makes that formalism conditional
# on the concept's own nature; forced rigorous math/proof notation is reserved
# for "research".
...
# mathematical results. "college" level is separately conditional per-concept
